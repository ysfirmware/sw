...
<Project Type="Project" LVVersion="15008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="GEN4 FTS Test Report rev2.xlsx" Type="Document" URL="../Template/GEN4 FTS Test Report rev2.xlsx"/>
		<Item Name="GEN4 FTS Test Report rev1.xlsx" Type="Document" URL="../Template/GEN4 FTS Test Report rev1.xlsx"/>
		<Item Name="FTS Profile.csv" Type="Document" URL="../Template/FTS Profile.csv"/>
		<Item Name="_Gen4 protocol_Ver2_0_1.docx" Type="Document" URL="../_Gen4 protocol_Ver2_0_1.docx"/>
		<Item Name="SUB_Write_GEN4_Init_data_V2_0_1.vi" Type="VI" URL="../sub/SUB_Write_GEN4_Init_data_V2_0_1.vi"/>
		<Item Name="SUB_Parsing_from_table_to_cluster.vi" Type="VI" URL="../sub/SUB_Parsing_from_table_to_cluster.vi"/>
		<Item Name="write_mode.ctl" Type="VI" URL="../Type definition/write_mode.ctl"/>
		<Item Name="FW_Dead_Packet_for_Debug_170202.vi" Type="VI" URL="../../FW_Dead_Packet_for_Debug_170202.vi"/>
		<Item Name="Debug_visa_close.vi" Type="VI" URL="../Debug_visa_close.vi"/>
		<Item Name="SUB_SORT_2D_ARRAY.vi" Type="VI" URL="../sub/SUB_SORT_2D_ARRAY.vi"/>
		<Item Name="Sub_Check_MAC_address.vi" Type="VI" URL="../sub/Sub_Check_MAC_address.vi"/>
		<Item Name="SUB-Calculation_Scale_of_CDC.vi" Type="VI" URL="../sub/SUB-Calculation_Scale_of_CDC.vi"/>
		<Item Name="SUB-ONE_Buffer.vi" Type="VI" URL="../sub/SUB-ONE_Buffer.vi"/>
		<Item Name="SUB-FTS_Result_divide.vi" Type="VI" URL="../sub/SUB-FTS_Result_divide.vi"/>
		<Item Name="EX382280_Interface.vi" Type="VI" URL="../sub/Power supply/EX382280_Interface.vi"/>
		<Item Name="382280_mode.ctl" Type="VI" URL="../sub/Power supply/382280_mode.ctl"/>
		<Item Name="Sub_serial_delay_and_Read_byte.vi" Type="VI" URL="../sub/Power supply/Sub_serial_delay_and_Read_byte.vi"/>
		<Item Name="Operation mode.ctl" Type="VI" URL="../sub/Operation mode.ctl"/>
		<Item Name="Linerity State.ctl" Type="VI" URL="../sub/Linerity State.ctl"/>
		<Item Name="Delay_ms.vi" Type="VI" URL="../sub/Delay_ms.vi"/>
		<Item Name="PP4.ico" Type="Document" URL="../../ICON/PP4.ico"/>
		<Item Name="New File Path Create.vi" Type="VI" URL="../sub/File Control/New File Path Create.vi"/>
		<Item Name="File_Interface.vi" Type="VI" URL="../sub/File Control/File_Interface.vi"/>
		<Item Name="File_Control_mode.ctl" Type="VI" URL="../sub/File Control/File_Control_mode.ctl"/>
		<Item Name="Sub-CDC_Data_Cluster_Buffer.vi" Type="VI" URL="../sub/Sub-CDC_Data_Cluster_Buffer.vi"/>
		<Item Name="Sub_X_Scale_Change.vi" Type="VI" URL="../sub/Sub_X_Scale_Change.vi"/>
		<Item Name="Sub_Report_Generation.vi" Type="VI" URL="../sub/Sub_Report_Generation.vi"/>
		<Item Name="DWG-03004-004-0-VERASENSE-FTS Support - Persona Gen4.xlsm" Type="Document" URL="../Template/DWG-03004-004-0-VERASENSE-FTS Support - Persona Gen4.xlsm"/>
		<Item Name="FTS Profile-OS.csv" Type="Document" URL="../Template/FTS Profile-OS.csv"/>
		<Item Name="add data3.ctl" Type="VI" URL="../Cluster Type/add data3.ctl"/>
		<Item Name="add data4.ctl" Type="VI" URL="../Cluster Type/add data4.ctl"/>
		<Item Name="Cal information.ctl" Type="VI" URL="../Cluster Type/Cal information.ctl"/>
		<Item Name="Device information.ctl" Type="VI" URL="../Cluster Type/Device information.ctl"/>
		<Item Name="PCAP zero information.ctl" Type="VI" URL="../Cluster Type/PCAP zero information.ctl"/>
		<Item Name="Acclerometer value(0, 45).ctl" Type="VI" URL="../Cluster Type/Acclerometer value(0, 45).ctl"/>
		<Item Name="Acclerometer value(90, 180).ctl" Type="VI" URL="../Cluster Type/Acclerometer value(90, 180).ctl"/>
		<Item Name="add data1.ctl" Type="VI" URL="../Cluster Type/add data1.ctl"/>
		<Item Name="add data2.ctl" Type="VI" URL="../Cluster Type/add data2.ctl"/>
		...
		<Item Name="SUB_Write_GEN4_Init_data_V2_0_1 - 88.vi" Type="VI" URL="../sub/SUB_Write_GEN4_Init_data_V2_0_1 - 88.vi"/>
		<Item Name="SUB_Write_GEN4_Init_data_V2_0_1 - 81.vi" Type="VI" URL="../sub/SUB_Write_GEN4_Init_data_V2_0_1 - 81.vi"/>
		<Item Name="SUB_Write_GEN4_Init_data_V2_0_1 - 83.vi" Type="VI" URL="../sub/SUB_Write_GEN4_Init_data_V2_0_1 - 83.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="SUB-module-Current VI Path.vi" Type="VI" URL="../SUB-module-Current VI Path.vi"/>
			<Item Name="_Serial Port-Initialize.vi" Type="VI" URL="../_Serial Port-Initialize.vi"/>
			...
			<Item Name="Control-CDC data.ctl" Type="VI" URL="../Control-CDC data.ctl"/>
			<Item Name="Control-IMU data.ctl" Type="VI" URL="../Control-IMU data.ctl"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="Control-Operation State Mark10.ctl" Type="VI" URL="../Control-Operation State Mark10.ctl"/>
			<Item Name="_Serial_Mark10-Connection_Check.vi" Type="VI" URL="../_Serial_Mark10-Connection_Check.vi"/>
			<Item Name="_Serial_Mark10-Control (Press Config).vi" Type="VI" URL="../_Serial_Mark10-Control (Press Config).vi"/>
			<Item Name="_Serial_Mark10-Setup.vi" Type="VI" URL="../_Serial_Mark10-Setup.vi"/>
			<Item Name="_Serial_Mark10-Data reception(Gauge).vi" Type="VI" URL="../_Serial_Mark10-Data reception(Gauge).vi"/>
			<Item Name="_Serial_Mark10-Config (Moving Speed).vi" Type="VI" URL="../_Serial_Mark10-Config (Moving Speed).vi"/>
			<Item Name="_Serial_Mark10-Head_Moving.vi" Type="VI" URL="../_Serial_Mark10-Head_Moving.vi"/>
			<Item Name="_Serial_Mark10-Receive data (Stand State).vi" Type="VI" URL="../_Serial_Mark10-Receive data (Stand State).vi"/>
			<Item Name="Control-Operation Test State FTS.ctl" Type="VI" URL="../Control-Operation Test State FTS.ctl"/>
			<Item Name="SUB-module-StringToArray.vi" Type="VI" URL="../SUB-module-StringToArray.vi"/>
			...
			<Item Name="_Serial_buf clear.vi" Type="VI" URL="../_Serial_buf clear.vi"/>
			...
			<Item Name="_Serial Port-Clear_Receive_Buffer.vi" Type="VI" URL="../_Serial Port-Clear_Receive_Buffer.vi"/>
			...
			<Item Name="Load_Array_Data_to_File_txt.vi" Type="VI" URL="../sub/File Control/Load_Array_Data_to_File_txt.vi"/>
			<Item Name="ble_write_message.vi" Type="VI" URL="../Lib_Bled112 toolkit/support_vi/ble_write_message.vi"/>
			<Item Name="BLED1112_app-discovery scan(170203).vi" Type="VI" URL="../BLED1112_app-discovery scan(170203).vi"/>
			<Item Name="ble_discover_ble_devices_170203.vi" Type="VI" URL="../Lib_Bled112 toolkit/ble_functions/ble_discover_ble_devices_170203.vi"/>
			<Item Name="BLED1112_auto-connection.vi" Type="VI" URL="../BLED1112_auto-connection.vi"/>
			<Item Name="SUB-Text_Blink.vi" Type="VI" URL="../sub/Alarm/SUB-Text_Blink.vi"/>
			<Item Name="Save_Array_Data_to_File.vi" Type="VI" URL="../sub/File Control/Save_Array_Data_to_File.vi"/>
			<Item Name="Sub_serial_Read_byte_until_0D0A.vi" Type="VI" URL="../sub/Power supply/Sub_serial_Read_byte_until_0D0A.vi"/>
			<Item Name="_Serial_Mark10-Setup(Zero).vi" Type="VI" URL="../_Serial_Mark10-Setup(Zero).vi"/>
			<Item Name="SUB-Interval_Realtime-Average.vi" Type="VI" URL="../sub/SUB-Interval_Realtime-Average.vi"/>
			<Item Name="SUB-RSSI_Realtime-Average.vi" Type="VI" URL="../sub/SUB-RSSI_Realtime-Average.vi"/>
			<Item Name="Control-BLED Rx (EVENT-Attribute Client).ctl" Type="VI" URL="../Control-BLED Rx (EVENT-Attribute Client).ctl"/>
			...
			<Item Name="Control-BLED Rx (EVENT-Connection status).ctl" Type="VI" URL="../Control-BLED Rx (EVENT-Connection status).ctl"/>
			...
			<Item Name="Control-BLED Rx (RESPONSE-GAP).ctl" Type="VI" URL="../Control-BLED Rx (RESPONSE-GAP).ctl"/>
			<Item Name="BLED1112-Rx Packet parser (RESPONSE-GAP).vi" Type="VI" URL="../BLED1112-Rx Packet parser (RESPONSE-GAP).vi"/>
			<Item Name="Control-BLED Rx (EVENT-Disconnected).ctl" Type="VI" URL="../Control-BLED Rx (EVENT-Disconnected).ctl"/>
			<Item Name="BLED1112-Rx Packet parser (EVENT-Disconnected).vi" Type="VI" URL="../BLED1112-Rx Packet parser (EVENT-Disconnected).vi"/>
			<Item Name="Control-BLED Rx (Get RSSI).ctl" Type="VI" URL="../Control-BLED Rx (Get RSSI).ctl"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="실행파일" Type="EXE">
				...
				<Property Name="Bld_version.build" Type="Int">197</Property>
				<Property Name="Bld_version.major" Type="Int">1</Property>
				<Property Name="Destination[0].destName" Type="Str">GEN4 PP4.exe</Property>
				<Property Name="Destination[0].path" Type="Path">../EXE/GEN4 PP4.exe</Property>
				...
				<Property Name="Destination[2].path" Type="Path">../EXE/Template</Property>
				<Property Name="DestinationCount" Type="Int">3</Property>
				<Property Name="Exe_iconItemID" Type="Ref">/My Computer/PP4.ico</Property>
				<Property Name="Source[0].itemID" Type="Str">{9C55E305-D95E-46E9-9948-DEF2F6195F35}</Property>
				...
				<Property Name="Source[3].itemID" Type="Ref">/My Computer/GEN4 FTS Test Report rev2.xlsx</Property>
				<Property Name="Source[3].sourceInclusion" Type="Str">Include</Property>
				<Property Name="Source[4].destinationIndex" Type="Int">2</Property>
				<Property Name="Source[4].itemID" Type="Ref">/My Computer/FTS Profile.csv</Property>
				<Property Name="Source[4].sourceInclusion" Type="Str">Include</Property>
				<Property Name="Source[5].destinationIndex" Type="Int">2</Property>
				<Property Name="Source[5].itemID" Type="Ref">/My Computer/DWG-03004-004-0-VERASENSE-FTS Support - Persona Gen4.xlsm</Property>
				<Property Name="Source[5].sourceInclusion" Type="Str">Include</Property>
				<Property Name="Source[6].destinationIndex" Type="Int">2</Property>
				<Property Name="Source[6].itemID" Type="Ref">/My Computer/FTS Profile-OS.csv</Property>
				...
				<Property Name="TgtF_targetfileName" Type="Str">GEN4 PP4.exe</Property>
			</Item>
			<Item Name="설치파일" Type="Installer">
				<Property Name="Destination[0].name" Type="Str">GEN4 PP4</Property>
				...
				<Property Name="DistPart[0].productName" Type="Str">NI-488.2 런타임 14.0</Property>
				<Property Name="DistPart[0].upgradeCode" Type="Str">{357F6618-C660-41A2-A185-5578CC876D1D}</Property>
				<Property Name="DistPart[1].flavorID" Type="Str">_deployment_</Property>
				<Property Name="DistPart[1].productID" Type="Str">{272BF3A9-7DBB-47EE-B2B8-CB893AA8166B}</Property>
				<Property Name="DistPart[1].productName" Type="Str">NI-VISA 런타임 16.0</Property>
				<Property Name="DistPart[1].upgradeCode" Type="Str">{8627993A-3F66-483C-A562-0D3BA3F267B1}</Property>
				<Property Name="DistPart[2].flavorID" Type="Str">DefaultFull</Property>
				<Property Name="DistPart[2].productID" Type="Str">{A8864B2C-7242-4C11-9D65-E88D200A66DE}</Property>
				<Property Name="DistPart[2].productName" Type="Str">NI LabVIEW 런타임 2015 SP1 f7</Property>
				<Property Name="DistPart[2].SoftDep[0].exclude" Type="Bool">false</Property>
				<Property Name="DistPart[2].SoftDep[0].productName" Type="Str">NI LabVIEW 런타임 2015 SP1 영어 외 다른 언어 지원.</Property>
				...
				<Property Name="DistPart[2].SoftDep[11].productName" Type="Str">NI 배포 프레임워크 2015</Property>
				...
				<Property Name="DistPart[2].SoftDep[12].productName" Type="Str">NI 에러 리포트 2015</Property>
				...
				<Property Name="DistPart[2].SoftDep[2].productName" Type="Str">NI System Web Server 15.5</Property>
				...
				<Property Name="DistPart[2].SoftDep[3].productName" Type="Str">Math Kernel 라이브러리</Property>
				...
				<Property Name="DistPart[2].SoftDep[4].productName" Type="Str">NI Logos 5.7</Property>
				...
				<Property Name="DistPart[2].SoftDep[5].productName" Type="Str">NI TDM Streaming 15.2</Property>
				...
				<Property Name="DistPart[2].SoftDep[6].productName" Type="Str">NI LabVIEW 웹 서버 2015</Property>
				...
				<Property Name="INST_buildLocation" Type="Path">../Install files</Property>
				...
				<Property Name="INST_productName" Type="Str">GEN4 PP4</Property>
				...
				<Property Name="Source[0].File[0].name" Type="Str">GEN4 PP4.exe</Property>
				<Property Name="Source[0].File[0].Shortcut[0].destIndex" Type="Int">1</Property>
				<Property Name="Source[0].File[0].Shortcut[0].name" Type="Str">GEN4 PP4</Property>
				<Property Name="Source[0].File[0].Shortcut[0].subDir" Type="Str"></Property>
				<Property Name="Source[0].File[0].Shortcut[1].destIndex" Type="Int">0</Property>
				<Property Name="Source[0].File[0].Shortcut[1].name" Type="Str">GEN4 PP4</Property>
				<Property Name="Source[0].File[0].Shortcut[1].subDir" Type="Str">GEN4 PP4</Property>
