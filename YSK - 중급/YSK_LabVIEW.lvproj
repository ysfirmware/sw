...
<Project Type="Project" LVVersion="14008000">
	<Item Name="내 컴퓨터" Type="My Computer">
		...
		<Item Name="1-1 이벤트핸들러.vi" Type="VI" URL="../1-1 이벤트핸들러.vi"/>
		<Item Name="1-2 신호시뮬레이션(열거형).vi" Type="VI" URL="../1-2 신호시뮬레이션(열거형).vi"/>
		<Item Name="1-3 클릭반응시간_UserInterfaceEventPattern 4.vi" Type="VI" URL="../1-3 클릭반응시간_UserInterfaceEventPattern 4.vi"/>
		<Item Name="1-3.1 클릭반응시간_UserInterfaceEventPattern 4.vi" Type="VI" URL="../1-3.1 클릭반응시간_UserInterfaceEventPattern 4.vi"/>
		<Item Name="1-4 난수 플롯(이벤트).vi" Type="VI" URL="../1-4 난수 플롯(이벤트).vi"/>
		<Item Name="1-5 난수플롯.vi" Type="VI" URL="../1-5 난수플롯.vi"/>
		<Item Name="2-1 상태머신.vi" Type="VI" URL="../2-1 상태머신.vi"/>
		<Item Name="3-2 생산자소비자(이벤트).vi" Type="VI" URL="../3-2 생산자소비자(이벤트).vi"/>
		<Item Name="3-3 콜라자판기 ProducerConsumerEvents 8.vi" Type="VI" URL="../3-3 콜라자판기 ProducerConsumerEvents 8.vi"/>
		<Item Name="3-3 콜라자판기.vi" Type="VI" URL="../3-3 콜라자판기.vi"/>
		<Item Name="4-2 난수발생.vi" Type="VI" URL="../4-2 난수발생.vi"/>
		<Item Name="5-3 VI run.vi" Type="VI" URL="../5-3 VI run.vi"/>
		<Item Name="6-1 글꼴설정.vi" Type="VI" URL="../6-1 글꼴설정.vi"/>
		<Item Name="6-3 웹브라우저.vi" Type="VI" URL="../6-3 웹브라우저.vi"/>
		<Item Name="8-1 컴퓨터ProcessID (DLL).vi" Type="VI" URL="../8-1 컴퓨터ProcessID (DLL).vi"/>
		<Item Name="8-5 화상키보드 실행.vi" Type="VI" URL="../8-5 화상키보드 실행.vi"/>
		<Item Name="9-1 파일경로(샘플00).vi" Type="VI" URL="../9-1 파일경로(샘플00).vi"/>
		<Item Name="9-1 파일경로.vi" Type="VI" URL="../build/공유라이브러리만들기/9-1 파일경로.vi"/>
		<Item Name="9-5 2진파일로부터읽기.vi" Type="VI" URL="../9-5 2진파일로부터읽기.vi"/>
		<Item Name="9-5 2진파일에쓰기.vi" Type="VI" URL="../9-5 2진파일에쓰기.vi"/>
		<Item Name="10-4 Create Table.vi" Type="VI" URL="../10-4 Create Table.vi"/>
		<Item Name="10-6 SQL Query.vi" Type="VI" URL="../10-6 SQL Query.vi"/>
		<Item Name="11-2 UDP Sender.vi" Type="VI" URL="../database/11-2 UDP Sender.vi"/>
		<Item Name="13-2 시리얼통신.vi" Type="VI" URL="../13-2 시리얼통신.vi"/>
		<Item Name="DB Tools Open Connection.vi" Type="VI" URL="../database/DB Tools Open Connection.vi"/>
		<Item Name="myControl_3_3.ctl" Type="VI" URL="../myControl_3_3.ctl"/>
		<Item Name="myMenu.rtm" Type="Document" URL="../myMenu.rtm"/>
		<Item Name="UserInterfaceEventPattern 3.vi" Type="VI" URL="../UserInterfaceEventPattern 3.vi"/>
